...
#define FRAME_GRID_COLS 64
    ...
    public:
        ...
        //DLF SLAM
        Frame(const cv::Mat &imGray, const cv::Mat &imDepth, const double &timeStamp, DLF *dlfhandler,
        ...
        // DLF
        void ComputeStereoFromRGBDDLF(const cv::Mat &imDepth);
        cv::Mat UnprojectStereoDLF(const int &i);
        void ComputeBoWDLF();
    ...
    private:
        ...
        //DLF
        void UndistortKeyPointsDLF();
        void AssignFeaturesToGridDLF();
